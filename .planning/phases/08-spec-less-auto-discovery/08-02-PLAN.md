...
must_haves:
  truths:
    - "EndpointFuzzer discovers endpoints when Kiterunner is available on the system"
...
5. **_discovered_to_endpoint(discovered: dict) method** returning `Endpoint`:
   - Import statement at top of file: `from api_pentest.core.models import Endpoint, EndpointClassification`
