...
must_haves:
  ...
  artifacts:
    - path: "api_pentest/scenarios/base_scenario.py"
      provides: "Default APPLICABILITY, format handling methods"
...
<task type="auto">
  ...
  <action>
    ...
    These methods give all scenarios access to safe format parsing.
  </action>
  <verify>
    Run: python -c "
...
"
  ...
  <done>
    BaseScenario has default APPLICABILITY, accepts api_profile in setup(), and provides parse_response_body() and parse_json_safe() methods.
  </done>
</task>
